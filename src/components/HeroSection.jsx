    ...
    <div className="flex items-center justify-center h-screen">
      ...
      <div className="p-2 m-8">
        <div className="text-center">
          ...
          <h2 className="font mt-4 lg:text-xl animate-pulse italic ">I create amazing web applications,<br></br> which provide exceptional user experiences 
          <br></br> and seamless functionality. </h2>
